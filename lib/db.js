// Database module - ES modules format for Vercel compatibility
  ...
  async updateUser(userId, updates) {
    try {
      ...
      const updatedUser = {
        ...
        passwordHash: currentUser.passwordHash, // Ensure password doesn't change
        salt: currentUser.salt, // Ensure salt doesn't change
